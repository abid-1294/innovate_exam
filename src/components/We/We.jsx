...
import We_1 from '../../assets/We_1.mp4'
import We_2 from '../../assets/We_2.mp4'
        ...
        <div className='py-[100px]'>
            ...
            <div className='relative'>
                <div className='w-[296px] h-[279px] border-[#D5E3F6] border-8 rounded-[28px] relative z-[2000]'>
                    <video src={We_1} alt="" autoPlay loop className='w-[296px] h-[279px] rounded-[28px] object-cover shadow-2xl shadow-green-400' />
                </div>
                <video src={We_2} alt="" autoPlay loop className='w-[440px] h-[467px] rounded-[28px] object-cover absolute top-[-230px] left-[200px] z-[1500] shadow-2xl shadow-blue-700' />
