        ...
        <div className="relative container mx-auto flex justify-between items-center pb-[145px]">
            ...
            <div className='mt-[400px]'>
                <div className='w-[461px] h-[433px] border-[#D5E3F6] border-8 rounded-[28px] relative z-[2000] ml-[-550px]'>
                    <video src={Banner1} alt="" autoPlay loop className='w-[461px]  h-[433px] rounded-[28px] object-cover shadow-2xl shadow-green-400' />
                </div>
                <video src={Banner2} alt="" autoPlay loop className='w-[458px] h-[430px] rounded-[28px] object-cover absolute top-[120px] right-[-150px] z-[1500] shadow-2xl shadow-blue-700' />
