        ...
        <div>
            <div className='container mx-auto flex flex-col items-center'>
                ...
                <div className='mt-[52px] flex space-x-10 pb-[100px]'>
                    <div className="text-center relative bg-[#EBF7E9] w-[380px] shadow-lg rounded-[20px] py-[52px] px-[48px] transition-all duration-700 hover:bg-[#6BD15A] group">
                    ...
                    <div className="text-center relative bg-[#D8EAFF] w-[380px] shadow-lg rounded-[20px] py-[52px] px-[48px] transition-all duration-700 hover:bg-[#3F80CC] group">
                        <div className='flex justify-center'>
